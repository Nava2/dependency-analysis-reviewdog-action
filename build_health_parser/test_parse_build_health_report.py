...
def test_main(simple_project_root: Path, tmp_path: Path):
    ...
    main([
        ...
        '--gradle_root', str(simple_project_root),
    ])
    ...
    with output_file.open() as f:
        ...
        assert f'{simple_project_root}/some/project/build.gradle.kts:3:4: ' \
               'Remove unused dependency: api(project(":common"))\n' in lines
        assert f'{simple_project_root}/some/project/build.gradle.kts:2:0: ' \
